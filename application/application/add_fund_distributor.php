...
class Add_fund_distributor extends CI_Controller {
	...
	public function pageview()
	{
		...
		$config['base_url'] = base_url()."add_fund_distributor/pageview";
		...
		$this->load->view('add_fund_distributor_view',$this->view_data);		
	}
		...
		if($this->input->post("hidSearchFlag") && $this->input->post("hidSearchValue"))
			...
			{								
				...
				if($result == true)
				{
					...
					redirect(base_url()."add_fund_distributor/pageview/".$start_page);
				}
			}
