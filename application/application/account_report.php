...
class Account_report extends CI_Controller {
	...
	public function pageview()
	{
		...
		$result = $this->Report->AccountLedger_getAllReport($this->session->userdata("admin_id"));
		...
		$this->view_data['result_mdealer'] = $this->Report->AccountLedger_getAllReport_limited($this->session->userdata("admin_id"),$start_row,$per_page);
		$this->view_data['message'] =$this->msg;
		$this->load->view('account_report_view',$this->view_data);		
	}
...
$this->output->set_header("Pragma: no-cache"); 
		...
		{ 	
			if($this->input->post('btnSearch') == "Search")
			{
				...
				$this->view_data['result_mdealer'] = $this->Report->AccountLedger_getReport($this->session->userdata("admin_id"),$from_date,$to_date);
				$this->view_data['message'] =$this->msg;
				$this->load->view('account_report_view',$this->view_data);		
			}					
