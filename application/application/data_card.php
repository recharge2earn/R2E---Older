...
class Data_card extends CI_Controller {
  ...
  { 
    ...
    $this->output->set_header("Pragma: no-cache"); 
      ...
      {
        $this->session->set_flashdata('message', 'Configuration Missing, Contact Service Provider.');
        redirect(base_url()."data_card"); 
      }
      ...
      {         
          ...
          $this->load->view('data_card_view',$this->view_data);
      }
    } 
  }
}
