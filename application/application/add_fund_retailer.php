...
class Add_fund_retailer extends CI_Controller {
	...
	public function user()
	{
		...
		$config['base_url'] = base_url()."add_fund_retailer/user";
		...
		$this->load->view('add_fund_retailer_view',$this->view_data);		
	}
		...
		{ 	
			...
			{							
				...
				if($result == true)
				{
					...
					redirect(base_url()."add_fund_retailer/user/".$start_page);
				}
			}
