...
class Dealer_home extends CI_Controller {
	private $msg='';
	public function pageview()
	{
		...
		$config['base_url'] = base_url()."dealer_home/pageview";
		$config['total_rows'] = $total_row;
		$config['per_page'] = $per_page; 
		$this->pagination->initialize($config); 
		$this->view_data['pagination'] = $this->pagination->create_links();
		$this->view_data['result_dealer'] = $this->D_list_dealer_model->get_retailer_limited($start_row,$per_page,$this->session->userdata('id'));
		$this->view_data['message'] =$this->msg;
		$this->load->view('dealer_home_view',$this->view_data);		
	}
