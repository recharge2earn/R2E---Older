...
class Retailer_report1 extends CI_Controller {
...
$this->output->set_header("Pragma: no-cache"); 
		...
		else if($this->input->post('btnSearch'))
		{
			...
			$this->load->model('Retailer_report1_model');
			$this->view_data['result_rch'] = $this->Retailer_report1_model->get_recharge($from,$to,$user_id);
			$this->view_data['message'] =$this->msg;
			$this->load->view('retailer_report1_view',$this->view_data);								
		}
		else 
		{ 						
