...
//////SMS API END////
					...
					$this->session->set_flashdata('message', 'Congratulation ! Your Account has been Created Successfully.<br /> We have sent login details on whatsapp.<br /> To login You should  <strong> <a href="login" class="alert-link">Click Here</a></strong> ');
				redirect("register");
				}
