...
public function ProcessBalanceForLongcode($userinfo)

	{
...

		{
			...
			$Description = "SMS_CHARGE  Balance Check";

			$this->load->model("Insert_model");

			$this->Insert_model->tblewallet_Recharge_DrEntry($user_id,0,$transaction_type,$dr_amount,$Description);
...
$result_sms = $this->common->ExecuteSMSApi($this->common_value->getSMSUserName(),$this->common_value->getSMSPassword(),$mobile_no,$smsMessage);
...

		{
			...
			echo "Insufficient Balance to Pay SMS charge";exit;
...

	{
...

		{
			...
			$Description = "SMS_CHARGE  Last 3 Transaction Check";
