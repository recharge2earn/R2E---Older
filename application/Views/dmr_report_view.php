...
<head>
    ...
    <title>Domestic money transafer report</title>
...
<body onLoad="setdefaultcircle()"> 
 <?php include("menu.php"); ?>
   ...
   <?php
    ...
    <div class="panel panel-primary">
      <div class="panel-heading">Money Transfer Transaction Report</div>
      <div class="panel-body"><form class="form-inline" action="<?php echo base_url()."dmr_report"; ?>" method="post" name="frmReport" id="frmReport">
  ...
  <td><?php echo "<span id='db_ssid".$i."'>".$result->commission_per."</span>"; ?></td>
 ...
 <td><?php echo "<span id='db_mobile".$i."'>".$result->amount."</span>"; ?></td> 
    ...
    {
        $dr_per = $result->commission_per*$result->amount/100;
        $total_commission += $result->commission_amount;
        $debit_amount = $dr_per+$result->amount;
    }
    else
    {
        $debit_amount = 0;
 ...
 <td><?php echo "<span id='db_amount".$i."'>".$result->recharge_date." ".$result->recharge_time."</span>"; ?></td>
