...
<div class="panel panel-primary">
      <div class="panel-heading">Master Distributor Registration Form</div>
...
<label for="txtDistname">Master Distributor Name :</label>
<input type="text" class="form-control" required="" title="Enter Master Distributor Name." id="txtDistname" name="txtDistname"  maxlength="100" value="<?php echo $regData['distributer_name']; ?>"/>
</div>
...
<select class="form-control" required="" id="ddlState" name="ddlState" onChange="getCityName('<?php echo base_url()."local_area/getCity/"; ?>')" title="Select State.Click on drop down"><option value="0">Select State</option>
<?php
...
<select class="form-control" id="ddlCity" name="ddlCity" title="Select City.Click on drop down">
...
<input type="number" class="form-control" required="" onKeyPress="return isNumeric(event);" title="Enter Mobile No.e.g. 9898980000" id="txtMobNo" name="txtMobNo" maxlength="10" value="<?php echo $regData['mobile_no']; ?>"/>
</div>

<div class="form-group">
<label for="txtLandNo">Alternate number :</label><input type="number" class="form-control" id="txtLandNo" name="txtLandNo" onKeyPress="return isNumeric(event);" title="Enter Landline No.e.g 07926453647" maxlength="11" value="<?php echo $regData['landline']; ?>"/>
</div>

<div class="form-group">
<label for="ddlRetType">Business Type :</label>
<select class="form-control"  id="ddlRetType" name="ddlRetType" title="Select Retailer Type.Click on drop down">
...
<input type="email" class="form-control" required="" id="txtEmail" title="Enter Email ID.e.g some@gmail.com" name="txtEmail"  maxlength="150" value="<?php echo $regData['emailid']; ?>"/>
</div>

<div class="form-group">
<label for="txtpanNo">Pan No :</label>
<input type="text" name="txtpanNo" class="form-control" id="txtpanNo" value="<?php echo $regData['pan_no']; ?>"/>
...
<div class="form-group">
    ...
    <select class="form-control" required="" id="ddlSchDesc" onChange="ChangeAmount()" title="Select Scheme Name.Click on drop down" name="ddlSchDesc">
...
<div class="form-group">
    ...
    <input type="text" title="Enter Opening Balance.e.g 1500,2500" onKeyPress="return isNumeric(event);" class="form-control" id="txtWorLimit" name="txtWorLimit" maxlength="50" value="<?php echo $regData['working_limit']; ?>"/>
