...
<form action="<?php echo base_url()."d_agent_balance_report"; ?>" method="post" name="frmReport" id="frmReport">
<fieldset>
...
<select title="Select Agent Name." name="ddlUserName" id="ddlUserName" class="select">
    ...
    <?php
		$result_retailer = $this->db->query("select * from tblusers where usertype_name='Agent' and parent_id='".$this->session->userdata('id')."' order by business_name");		
...
<table style="width:100%;" cellpadding="3" cellspacing="0" border="0">
	...
	<th scope="col" align="left">Agent Name</th>    
