...
<title>Manage Master Distributor</title>
...
<div class="panel panel-primary">
      <div class="panel-heading"><b>TOTAL MASTER DEALER BALANCE: <?php echo $totalLoad;?></b></div>
...
<td><a class="btn btn-primary" href="<?php echo base_url()."profile/view/".$this->Common_methods->encrypt("Distributor")."/".$this->Common_methods->encrypt($result->user_id);?>" target="_blank">View Profile</a></td>
 ...
 <td><a title="Edit Profile" class="btn btn-warning" href="<?php echo base_url()."md_dealer_edit/process/".$this->Common_methods->encrypt($result->user_id); ?>" >Edit Profile</a></td> 
