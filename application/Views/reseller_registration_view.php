...
<div class="panel panel-primary">
      <div class="panel-heading">API Registraion Form</div>
    ...
    ?>
<form method="post" action="reseller_registration" name="frmdistributer_form1" id="frmdistributer_form1" autocomplete="off">
...
<div class="form-group">
<label for="txtpanNo">Pan /GST/Adhaar Number:</label>
