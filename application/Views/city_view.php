...
<title>State</title>
   <?php include("script1.php");?>    
	...
	function SetEdit(value)
	{
		...
		document.getElementById('ddlStateName').value=document.getElementById("name_"+value).innerHTML;
...
<div id="container">
 ...
 <?php require_once("a_header.php"); ?> 
  ...
  <div class="bck">
    <h2 class="border_bottom"><span id="myLabel">Add New State</span></h2>                 
    <?php
...
<table style="width:100%;" id="example" class='dataTable' cellpadding="3" cellspacing="0" border="0">
    ...
    <?php	$i = 0;foreach($result_city->result() as $result) 	{  ?>
			<tr class="<?php if($i%2 == 0){echo 'row1';}else{echo 'row2';} ?>">
            	<td class="padding_left_10px box_border_bottom box_border_right" align="left" height="34" style="min-width:120px;width:150px;"><span id="cname_<?php echo $result->city_id; ?>"><?php echo $result->city_name; ?></span></td>
                <td class="padding_left_10px box_border_bottom box_border_right" align="left" height="34" style="min-width:120px;width:150px;"><span id="name_<?php echo $result->city_id; ?>"><?php echo $result->state_name; ?></span>
