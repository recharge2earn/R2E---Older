...
<div id="container">
 ...
 <?php require_once("a_header.php"); ?> 
  ...
  <div class="bck">
<h2>Admin Recharge Commission Report</h2>
<form action="<?php echo base_url()."parent_commission_report"; ?>" method="post" name="frmReport" id="frmReport">
From Date :<input type="text" name="txtFrom" id="txtFrom" class="text" title="Select From Date." maxlength="10" /> </td>
To Date :<input type="text" name="txtTo" id="txtTo" class="text" title="Select From To." maxlength="10" />
...
<table style="width:100%;" id="example" class='dataTable' cellpadding="3" cellspacing="0" border="0">
   ...
   <th class="padding_left_10px box_border_bottom box_border_right background_gray" align="center" width="30" height="30" >Amount</th>
     <th class="padding_left_10px box_border_bottom box_border_right background_gray" align="center" width="30" height="30" >Received Commission</th>   
	  <th class="padding_left_10px box_border_bottom box_border_right background_gray" align="center" width="30" height="30" >Cost</th>    <th class="padding_left_10px box_border_bottom box_border_right background_gray" align="center" width="60" height="30" >ExecuteBy</th>    
	...
	{
	$discount = ($result->recAmount * $result->totalCommissionPer)/100;
	$cost = $result->recAmount - $discount;
	$total_cost = $total_cost + $cost;
	if($result->ExecuteBy == 'RechargeServer')
	{
		$color = '#FF3399';
	}
	else if($result->ExecuteBy == 'RoyalCapital')
	{
		$color = '#33CC33';
	}
	else if($result->ExecuteBy == 'RechargeDunia')
	{
		$color = '#00CCFF';
	}
	else if($result->ExecuteBy == 'NEW_MARS')
	{
		$color = '#CCFF00';
	}
	  ?>
...
<td class="padding_left_10px box_border_bottom box_border_right" align="center" height="34" style="width:150px;"><?php echo "<span id='db_amount".$i."'>".$result->recAmount."</span>"; ?></td>
 <td class="padding_left_10px box_border_bottom box_border_right" align="center" height="34" style="width:150px;"><?php echo "<span id='db_amount".$i."'>".$result->amount."</span>"; ?></td>
  ...
  <td class="padding_left_10px box_border_bottom box_border_right" align="center" height="34" style="width:150px;"><?php echo "<span id='db_amount".$i."'>".$cost."</span>"; ?></td>
   <td class="padding_left_10px box_border_bottom box_border_right" align="center" height="34" style="width:150px;"><?php echo "<span id='db_amount".$i."' ><font style='font-size:17px'>".$result->ExecuteBy."</font></span>"; ?></td>
 ...
 <td class="padding_left_10px box_border_bottom box_border_right" align="center" height="34" style="width:150px;">
  ...
  <?php if($result->recharge_status == "Failure"){echo "<span id='db_status".$i."' class='red'>".$result->recharge_status."</span>";} ?>
    ...
    <th class="padding_left_10px box_border_bottom box_border_right background_gray" align="center" width="120" height="30" ></th>
    <th class="padding_left_10px box_border_bottom box_border_right background_gray" align="center" width="120" height="30" >Successfull Transaction :</th>        
     <th class="padding_left_10px box_border_bottom box_border_right background_gray" align="center" width="120" height="30" ><?php echo $total_amount; ?></th>        
     <th class="padding_left_10px box_border_bottom box_border_right background_gray" align="center" width="120" height="30" ><?php echo $total_commission;?></th>        
        <th class="padding_left_10px box_border_bottom box_border_right background_gray" align="center" width="120" height="30" ><?php echo $total_cost; ?></th>        
