...
<title>Distributor Balance Report</title>
...
<form action="<?php echo base_url()."d_dealer_balance_report"; ?>" method="post" name="frmReport" id="frmReport">
<fieldset>
...
<select title="Select Dealer Name." name="ddlUserName" id="ddlUserName" class="select">
    ...
    <?php
		$result_retailer = $this->db->query("select * from tblusers where usertype_name='Distributor' and parent_id='".$this->session->userdata('id')."' order by business_name");		
