...
<body onLoad="setdefaultcircle()"> 
 <?php include("menu.php"); ?>
   ...
   <?php
    ...
    <div class="panel panel-primary">
      <div class="panel-heading">Credit Debit Summary</div>
 ...
 <th>Balance</th>
          ...
          <tbody>'
    ;
	$str_query_recharge = "select tblewallet.* from tblewallet where user_id =?  order by tblewallet.Id desc limit 0, 500";
