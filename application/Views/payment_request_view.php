...
<div id="container">
  <div>
   <h2><span id="myLabel">Payment Request</span></h2>           
	...
	?>
<form action="<?php echo base_url().'payment_request'; ?>" method="post" name="frmPayment" id="frmPayment">
    <fieldset>    
...
<tr>
  ...
  <tr>
	<td align="right"><label for="ddlClientBank"><span style="color:#F06">*</span>Bank Name :</label></td>
    <td align="left"><select id="ddlClientBank" name="ddlClientBank" title="Select Your Bank Name." class="select">			<option>---- * Select * ----</option>
    <?php
$str_query = "select * from tblbank where bank_id = (select bank_id from tblusers where user_id='".$this->session->userdata('id')."')";
