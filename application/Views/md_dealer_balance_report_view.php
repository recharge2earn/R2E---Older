...
<title>Master Distributor Balance Report</title>
...
<div id="container">
 ...
 <?php require_once("a_header.php"); ?> 
  ...
  <div class="bck">
<h2>Master Distributor Balance Report</h2>
<form action="<?php echo base_url()."md_dealer_balance_report"; ?>" method="post" name="frmReport" id="frmReport">
<fieldset>
...
<table style="width:100%;" cellpadding="3" cellspacing="0" border="0">
	...
	<th scope="col" align="left">Master Distributor Name</th>    
