...
<title>Extra Income Achive</title>
...
<div id="container">
 ...
 <?php require_once("general_header.php"); ?> 
  ...
  <div class="bck">
   ...
   <h2><span id="myLabel">Extra Income Earning</span></h2>           
    <?php
	if ($message != ''){echo "<div class='message'>".$message."</div>"; }
	?>    
     <form action="<?php echo base_url()."user_extra_income" ?>" method="post" name="frmSearch" id="frmSearch">
     <fieldset>
...
<table style="width:100%;" cellpadding="3" cellspacing="0" border="0">
 ...
 <td><?php echo "<span id='db_trno".$i."'>".$result->remark."</span>"; ?></td> 
