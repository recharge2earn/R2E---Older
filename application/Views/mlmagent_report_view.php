...
<div id="container">
 ...
 <?php require_once("a_header.php"); ?> 
  ...
  <div class="bck">
<h2>MLM Agent Transaction Report</h2>
<form action="<?php echo base_url()."mlmagent_report"; ?>" method="post" name="frmReport" id="frmReport">
<fieldset>
...
<select title="Select Agent Name." name="ddlUserName" id="ddlUserName" class="select">
    ...
    <?php
		$result_retailer = $this->db->query("select * from tblusers where usertype_name='MLMAgent' order by business_name");		
