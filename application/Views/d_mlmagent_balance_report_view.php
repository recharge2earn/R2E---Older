...
<title>MLM Agent Balance Report</title>
...
<div id="container">
 ...
 <?php require_once("general_header.php"); ?> 
  ...
  <div class="bck">
<h2>MLM Agent Balance Report</h2>
<form action="<?php echo base_url()."d_mlmagent_balance_report"; ?>" method="post" name="frmReport" id="frmReport">
<fieldset>
...
<table style="width:100%;" cellpadding="3" cellspacing="0" border="0">
	...
	<th scope="col" align="left">MLM Agent Name</th>    
