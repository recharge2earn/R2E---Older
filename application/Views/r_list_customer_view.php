...
<div id="container">
 ...
 <?php require_once("general_header.php"); ?> 
  ...
  <div>
<h2>View Customer</h2>  
 <form action="<?php echo base_url()."r_list_customer" ?>" method="post" name="frmCallAction" id="frmCallAction">
...
<input type="hidden" id="hidaction" name="hidaction" value="Set" />
	...
	?>    
    <form action="<?php echo base_url()."r_list_customer" ?>" method="post" name="frmSearch" id="frmSearch">
     <fieldset>
...
<table style="width:100%;" cellpadding="3" cellspacing="0" border="0">
    ...
    <?php	$i = 0;foreach($result_retailer->result() as $result) 	{  ?>
			<tr class="<?php if($i%2 == 0){echo 'row1';}else{echo 'row2';} ?>">
             <td><?php echo '<a href="'.base_url().'r_add_balance/process/'.$result->user_id.'" class="paging">Add Balance</a>'; ?></td>
