...
<title>Agent Detail Report</title>
...
<div id="container">
 ...
 <?php require_once("a_header.php"); ?> 
  ...
  <div class="bck">
<h2>Agent Detail Report</h2>
<form action="<?php echo base_url()."retailer_report1"; ?>" method="post" name="frmReport" id="frmReport">
<fieldset>
...
<select title="Select Agent Name." name="ddlUserName" id="ddlUserName" class="select">
    ...
    <?php		
		$result_dealer = $this->db->query("select * from tblusers where usertype_name='Agent' order by business_name");		
