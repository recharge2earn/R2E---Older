...
<title>Super Dealer Transaction</title>
...
<div id="container">
 ...
 <?php require_once("a_header.php"); ?> 
  ...
  <div class="bck">
<h2>Master Dealer Transaction</h2>
<form action="<?php echo base_url()."sd_dealer_report"; ?>" method="post" name="frmReport" id="frmReport">
<fieldset>
...
<td>
<select title="Select Super Dealer Name." name="ddlUserName" id="ddlUserName" class="select">
