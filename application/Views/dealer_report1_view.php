...
<title>Distributor Detail Report</title>
...
<div id="container">
 ...
 <?php require_once("a_header.php"); ?> 
  ...
  <div class="bck">
<h2>Distributor Detail Report</h2>
<form action="<?php echo base_url()."dealer_report1"; ?>" method="post" name="frmReport" id="frmReport">
<fieldset>
...
<select title="Select Master Distributor Name." name="ddlUserName" id="ddlUserName" class="select">
    ...
    <?php		
		$result_dealer = $this->db->query("select * from tblusers where usertype_name='Distributor' order by business_name");		
...
<table style="width:100%;" cellpadding="3" cellspacing="0" border="1">
   ...
   <th scope="col" align="left">GTID</th>        
