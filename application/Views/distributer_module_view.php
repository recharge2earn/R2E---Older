...
<title>Distributer Module</title>
...
<div id="container">
 ...
 <?php require_once("general_header.php"); ?> 
  ...
  <td valign="middle" align="center"><a href="<?php echo base_url()."distributer_home"; ?>" class="module"><span><br><br>Recharge System</span></a></td>
  </tr>
  </table>
  </div>
    </center>
