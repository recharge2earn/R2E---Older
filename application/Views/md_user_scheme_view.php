 ...
 <?php require_once("general_menu.php"); ?> 
  ...
  <div>
   <h1><span id="myLabel">User Scheme</span></h1>           
	...
	?>    
     <form action="<?php echo base_url()."md_user_scheme" ?>" method="post" name="frmSearch" id="frmSearch">
     <fieldset>
...
<option>--Select--</option>
<?php		
		$str_query = "select * from tblscheme where (scheme_type='Distributor' or scheme_type='Agent')";
