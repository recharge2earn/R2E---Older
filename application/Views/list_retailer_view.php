...
<div id="container">
 ...
 <?php require_once("a_header.php"); ?> 
  ...
  <div>
<h2>View Retailer</h2>  
 <form action="<?php echo base_url()."list_retailer" ?>" method="post" name="frmCallAction" id="frmCallAction">
...
<input type="hidden" id="hidaction" name="hidaction" value="Set" />
	...
	?>    
     <form action="<?php echo base_url()."list_retailer" ?>" method="post" name="frmSearch" id="frmSearch">
     <fieldset>
...
<table style="width:100%;" cellpadding="3" cellspacing="0" border="0">
    ...
    <th scope="col" align="left">Retailer Name</th>
...
<td><a href="<?php echo base_url()."edit_retailer_form1/process/".$result->user_id; ?>" title="Edit Retailer"><img src="<?php echo base_url()."images/Edit.PNG"; ?>" border="0" title="Edit Retailer" /></a></td>            
