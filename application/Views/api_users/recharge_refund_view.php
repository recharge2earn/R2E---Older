...
<h2>Recharge Refund Report</h2> 
 ...
 <form action="<?php echo base_url()."api_users/recharge_refund" ?>" method="post" name="frmCallAction" id="frmCallAction">
...
<div class="breadcrumb">    
     <form action="<?php echo base_url()."api_users/recharge_refund" ?>" method="post" name="frmSearch" id="frmSearch">
