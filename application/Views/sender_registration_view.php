...
<head>
    ...
    <title>Sender Registraion</title>
 ...
 <?php include("dmr_menu.php"); ?>
  ...
  <div class="container">
    ...
    ?>
            ...
            <form action="<?php echo base_url()."sender_registration"; ?>" method="post" autocomplete="off" name="frmChangePassword" id="frmChangePassword">
     ...
     <input class="form-control" required="" id="mobile" name="mobile"  placeholder="Please enter mobile number" data-toggle="tooltip" title="Please enter mobile number" type="number" />
     </div>
