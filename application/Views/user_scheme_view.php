...
<body class="twoColFixLtHdr">
 ...
 <?php require_once("a_header.php"); ?> 
  ...
  <div id="menu">
   ...
   <div class="bck">
  <div>
   <h2><span id="myLabel">User Scheme</span></h2>           
    <?php
	if ($message != ''){echo "<div class='message'>".$message."</div>"; }
	?>    
     <form action="<?php echo base_url()."user_scheme" ?>" method="post" name="frmSearch" id="frmSearch">
     <fieldset>
...
<?php
		$typeName='Admin';
		$str_query = "select CASE usertype_name WHEN 'SuperDealer' THEN business_name WHEN 'Admin' THEN business_name WHEN 'MasterDealer' THEN business_name WHEN 'Distributor' THEN business_name WHEN 'Agent' THEN business_name END as name,user_id from tblusers where usertype_name != ?";
...
<option>--Select--</option>
<?php		
		$str_query = "select * from tblscheme";
