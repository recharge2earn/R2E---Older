...
<div class="panel panel-primary">
      <div class="panel-heading">Retailer Recharge Report</div>
      <div class="panel-body">


<form class="form-inline" action="<?php echo base_url()."agent_report"; ?>" method="post" name="frmReport" id="frmReport">

<div class="form-group">
    <label for="ddlUserName">Select Retailer: </label>

<select title="Select Agent Name." name="ddlUserName" id="ddlUserName" class="form-control">
...
<input type="submit" name="btnSearch" id="btnSearch" value="Search" class="btn btn-primary" title="Click to search." />
    ...
    if(isset($result_rch))
    {
        ...
        {
    ?>
    <h2>Recharge Report From <?php echo $from;?>&nbsp;&nbsp;&nbsp;To&nbsp;&nbsp;&nbsp;<?php echo $to; ?></h2>
...
<td><?php echo "<span id='db_trno".$i."'>".$result->transaction_id."</span>"; ?></td> 
 ...
 <td><?php echo "<span id='db_date".$i."'>".$result->business_name."</span>"; ?></td>
