 ...
 <?php include("dmr_menu.php"); ?>
  ...
  <div class="container">
    ...
    <div class="panel panel-primary">
      <div class="panel-heading">Add Beneficiary</div>
    ...
    ?>
            ...
            <form action="<?php echo base_url()."add_beneficiary"; ?>" method="post" autocomplete="off" name="frmChangePassword" id="frmChangePassword">
     ...
     <input class="form-control" required="" id="ben_name" name="ben_name"  placeholder="Please enter Beneficiary Name" data-toggle="tooltip" title="Please enter Beneficiary Name" type="text" />
     </div>


      <div class="form-group">
     <label for="ben_mobile">Beneficiary Mobile:</label>
     <input class="form-control" required="" id="ben_mobile" name="ben_mobile"  placeholder="Please enter ben_mobile number" data-toggle="tooltip" title="Please enter ben_mobile number" type="number" />
     </div>
     
     
       <div class="form-group">
     <label for="ben_account">Bank Account Number:</label>
     <input class="form-control" required="" id="ben_account" name="ben_account"  placeholder="Please enter account number" data-toggle="tooltip" title="Please enter account number" type="number" />
     </div>
     
     <div class="form-group">
     <label for="ifsc">IFSC Code:</label>
     <input class="form-control" required="" id="ifsc" name="ifsc"  placeholder="Please enter IFSC Code" data-toggle="tooltip" title="Please enterIFSC Code" type="text" />
     </div>
