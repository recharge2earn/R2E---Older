...
<body onLoad="setdefaultcircle()"> 
 <?php include("menu.php"); ?>
   ...
   <?php
    ...
    <div class="panel panel-primary">
      <div class="panel-heading">My Earning</div>
      <div class="panel-body"><form class="form-inline" action="<?php echo base_url()."my_earning"; ?>" method="post" name="frmReport" id="frmReport">
 ...
 <td><?php echo "<span id='db_mobile".$i."'>".$result->amount."</span>"; ?></td> 
    ...
    if($result->recharge_status == "Success")
    {
        ...
        $debit_amount = $result->commission_amount;
    }
    else
    {
        $debit_amount = 0;
