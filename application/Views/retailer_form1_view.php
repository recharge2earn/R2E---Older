...
<tr>
<td align="right"><label for="txtFranName"><span style="color:#F06">*</span>Retailer Name :</label></td><td align="left"><input type="text" class="text" title="Enter Retailer Name." id="txtFranName" name="txtFranName"  maxlength="100"/>
...
<input type="hidden" name="hidDistname" id="hidDistname" />
...
<td align="right"><label for="ddlCity">City/District :</label></td><td align="left"><select class="select" id="ddlCity" onChange="getAreaName('<?php echo base_url()."local_area/getArea/"; ?>')" name="ddlCity" title="Select City.<br />Click on drop down"><option value="0">Select City</option>
</select></td>
</tr>
<tr>
...
<td align="right"><label for="ddlPreLang">Prefered Language :</label></td><td align="left"><select class="select" id="ddlPreLang" name="ddlPreLang" title="Select Prefered Language.<br />Click on drop down"><option>--Select--</option><option>English</option><option>Gujarati</option><option>Hindi</option></select></td>
</tr>
<tr>
