...
<head>
    ...
    <title>White List Ip Adress</title>
 ...
 <?php include("menu.php"); ?>
   ...
   <?php
    ...
    <div class="panel panel-primary">
      <div class="panel-heading">Set IP</div>
      <div class="panel-body">
    <?php
$str_query = "select * from tblusers where user_id=".$this->session->userdata('id')."";
$result_user = $this->db->query($str_query);		
?>    
<form method="post" action="set_ip" name="frmchange_profile" id="frmchange_profile" autocomplete="off">

<div class="form-group">
<label for="txtDistname">IP Address :</label>
<input type="text" class="form-control"  title="Please Enter Your server IP." value="<?php echo $result_user->row(0)->ip_address; ?>" id="ip_address" name="ip_address"  maxlength="500"/>
</div>
