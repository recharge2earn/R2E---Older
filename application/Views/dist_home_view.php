...
<div class="panel panel-primary">
      <div class="panel-heading">Manage Retailer</div>
...
<td><?php echo $result->business_name; ?></td>
 ...
 <td><?php echo '<a class="btn btn-danger" title="Transfer Money" href="'.base_url().'common_add_balance/process/'.$this->Common_methods->encrypt($result->user_id).'/'.$this->Common_methods->encrypt('dist_home').'/'.$this->Common_methods->encrypt('Add').'" class="paging">Credit</a>';?></td>
 <td><?php echo '<a class="btn btn-primary" title="Revert Transaction" href="'.base_url().'common_add_balance/process/'.$this->Common_methods->encrypt($result->user_id).'/'.$this->Common_methods->encrypt('dist_home').'/'.$this->Common_methods->encrypt('Revert').' " class="paging">Debit</a>';?></td>
