...
<div id="container">
 ...
 <?php require_once("general_header.php"); ?> 
  ...
  <div>
<h2>View Customer</h2>  
 <form action="<?php echo base_url()."c_list_customer" ?>" method="post" name="frmCallAction" id="frmCallAction">
...
<input type="hidden" id="hidaction" name="hidaction" value="Set" />
	...
	?>    
    <form action="<?php echo base_url()."c_list_customer" ?>" method="post" name="frmSearch" id="frmSearch">
     <fieldset>
