...
$(document).ready(function(){
	...
	function validateDname(){
		...
		if(dname.val() == ""){
			...
			jAlert('Enter Distributer Name.<br /> e.g Suresh', 'Alert Dialog');
			dnameInfo.text("");
...
<div id="container">
 ...
 <?php require_once("general_header.php"); ?> 
  ...
  <div>
	...
	?>
<form method="post" action="d_registration" name="frmdistributer_form1" id="frmdistributer_form1" autocomplete="off">
<fieldset>
<legend>Personal Information</legend>
<table cellpadding="5" cellspacing="0" bordercolor="#f5f5f5" width="80%" border="0">
<tbody>
<tr>
<td align="right"><label for="txtDistname"><span style="color:#F06">*</span>Distributor Name :</label></td><td align="left"><input type="text" class="text" title="Enter Distributer Name." id="txtDistname" name="txtDistname"  maxlength="100"/>
...
<tbody>
  <tr>
    <td align="right"><label for="ddlBank"><span style="color:#F06">*</span> Bank :</label></td>
    <td align="left"><select id="ddlBank" name="ddlBank" title="Select Bank Name.<br />Click on drop down" class="select">
...
?>
      ...
      <span id="ddlbankInfo"></span></td>
    <td align="right">Additional Bank :</td>
    <td align="left"><select class="select" id="ddlAddBank" name="ddlAddBank" title="Select Additional Bank Name.<br />Click on drop down">
...
?>
  ...
  <tr>
    <td align="right"><label for="ddlAcType">Account Type :</label></td>
    <td align="left"><select class="select" id="ddlAcType" name="ddlAcType" title="Select Account Type.<br />Click on drop down">
      <option>SAVING</option>
      <option>CURRENT</option>
      <option>OD</option>
    </select></td>
    <td align="right">Additional A/C Type :</td>
    <td><select class="select" id="ddlAcType_2" name="ddlAcType_2" title="Select Account Type.<br />Click on drop down">
      <option>SAVING</option>
      <option>CURRENT</option>
      <option>OD</option>
    </select></td>
  ...
  <tr>
    <td align="right"><label for="txtAcNo"><span style="color:#F06">*</span> Account No :</label></td>
    <td align="left"><input type="text" class="text" id="txtAcNo" title="Enter Account No<br />e.g 100000005010" name="txtAcNo" maxlength="50"/>
      <span id="acnoInfo"></span></td>
    <td align="right">Additional A/C No2 :</td>
    <td><input type="text" class="text" id="txtAddAcNo2" title="Enter Account No 2.<br />e.g 1000002323900" name="txtAddAcNo2" maxlength="30"/></td>
  </tr>
  <tr>
    <td align="right"><label for="ddlOrg"><span style="color:#F06">*</span> Organisation :</label></td>
    <td align="left"><select class="select" id="ddlOrg" title="Select Organisation.<br />Click on drop down" name="ddlOrg">
      ...
      <span id="orgInfo"></span></td>
    <td align="right"><label for="ddlPreLang">Prefered Language :</label></td>
    <td align="left"><select class="select" id="ddlPreLang" name="ddlPreLang" title="Select Prefered Language.<br />Click on drop down">
      <option>--Select--</option>
...
?>
      ...
      <span id="schdescInfo"></span></td>
    <td></td>
    <td></td>
  </tr>
  <tr>
    <td align="right"><label for="radPayMode">Payment Mode :</label></td>
    <td colspan="2"><input onClick="SetPaymentMode()" type="radio" value="Cash" id="radCash" name="radPayMode"/>
      Cash
      <input type="radio" onClick="SetPaymentMode()" value="Cheque" id="radCheque" name="radPayMode" checked="checked"/>
      Cheque
      <input type="radio" onClick="SetPaymentMode()" value="DD/RTGS" id="radDD" name="radPayMode"/>
      DD/NFST/RTGS/Transfer</td>
  </tr>
  <tr>
    <td align="right"><label for="txtChqDDNo">Chq No./DD No. :</label></td>
    <td align="left"><input type="text" class="text" id="txtChqDDNo" name="txtChqDDNo" title="Enter Cheque No or Demand Draft No." maxlength="30"/></td>
    <td align="right"><label for="txtChqDDDate">Cheque/DD Date. :</label></td>
    <td align="left"><input type="text" class="text" id="txtChqDDDate" title="Enter Cheque Date or Demand Draft No." name="txtChqDDDate" maxlength="50"/></td>
  </tr>
  <tr>
    <td align="right" valign="top"><label for="ddlDepBank">Depositing Bank :</label></td>
    <td colspan="3" align="left"><select class="select" id="ddlDepBank" onChange="setAccount()" name="ddlDepBank" title="Select Deposit Bank Name.<br />Click on drop down">
      <option value="0">--Select--</option>
 <?php echo $this->common_value->getBankDetails(); ?>
     </select>
      <span id="deposit_account_no" style="font-weight:bold;"></span></td>
  </tr>
  <tr>
    <td align="right">Amount :</td>
    <td align="left"><span id="spAmount">0</span>
      <input type="hidden" id="hid_scheme_amount" name="hid_scheme_amount" /></td>
    <td align="right"><label for="txtWorLimit">Credit Amount :</label></td>
    <td align="left"><input type="text" title="Enter Working Limit.<br />e.g 1500,2500" onKeyPress="return isNumeric(event);" class="text" id="txtWorLimit" name="txtWorLimit" maxlength="50"/></td>
  </tr>
  <tr>
    <td></td>
    <td align="left"><input type="submit" style="width:180px" class="button" id="btnSubmit" name="btnSubmit" value="Submit Account Details"/>
