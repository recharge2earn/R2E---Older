...
<title>Master Distributor Transaction</title>
...
<div id="container">
 ...
 <?php require_once("a_header.php"); ?> 
  ...
  <div class="bck">
<h2>Master Distributor Transaction</h2>
<form action="<?php echo base_url()."md_dealer_report"; ?>" method="post" name="frmReport" id="frmReport">
<fieldset>
...
<td>
<select title="Select Master Distributor Name." name="ddlUserName" id="ddlUserName" class="select">
    <option value="0">--Select--</option>
    <?php
		echo "<option value='ALL'>ALL</option>";
		$result_dealer = $this->db->query("select * from tblusers where usertype_name='MasterDealer' order by business_name");		
...
<table style="width:100%;" cellpadding="3" cellspacing="0" border="0">
	...
	<th scope="col" align="left">Transaction ID</th>
 ...
 <td><?php echo "<span id='db_amount".$i."'>".$result->amount."</span>"; ?></td>
  ...
  <?php if($result->recharge_status == "Failure"){echo "<span id='db_status".$i."' class='red'>".$result->recharge_status."</span>";} ?>
   ...
   <td><a href="#" onClick="printContent('<?php echo "".$i ?>')">Print</a></td>
    ...
    <th scope="col" align="left"></th>            
    <th scope="col" align="left"></th>
    <th scope="col" align="left">Total Amount : </th>
