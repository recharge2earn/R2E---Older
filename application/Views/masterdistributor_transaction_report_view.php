...
<title>Master Distributor Report</title>
...
<div class="panel panel-primary">
      <div class="panel-heading">Master Distributor Recharge Report</div>
      <div class="panel-body">


<form class="form-inline" action="<?php echo base_url()."masterdistributor_transaction_reoprt"; ?>" method="post" name="frmReport" id="frmReport">

<div class="form-group">
    <label for="ddlUserName">Select Master Distributor: </label>

<select title="Select Distributor Name." name="ddlUserName" id="ddlUserName" class="form-control">
    <option value="0">--Select--</option>
    <?php
        $result_retailer = $this->db->query("select * from tblusers where usertype_name='MasterDealer' order by business_name");       
