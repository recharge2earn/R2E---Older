...
<input type="hidden" id="hidURLotp" name="hidURLotp" value="<?php echo base_url()."get_otp"; ?>"/>
  ...
  <?php
    ...
    <h2 style="margin:-5px;margin-left:-10px;margin-right:-11px;margin-bottom:-20px;" class="border shadow"><b style="color:#000000">Recharge</b></h2>
    <div align="left">
 ...
 <img src="<?php echo base_url().'images/ajax.gif'; ?>" width="128" height="15" align="middle" alt="Please wait we process your data." title="Please wait we process your data." border="none" />
    ...
    <form action="<?php echo base_url()."recharge_home"; ?>" method="post" name="frmRecharge" id="frmRecharge" autocomplete="off">
    ...
    <table  width="600px">
    <tr>
    <td align="right"><b style="color:#000000">Company Name : </b></td>
  ...
  <!-- <input type="radio" name="rbRecharge" value="LAPU"  id="rbLAPU" onClick="getLAPUCompany()"/> Lapu&nbsp;&nbsp;&nbsp;
   <input type="radio" name="rbRecharge" value="POSTPAID"  id="rbPOSTPAID" onClick="getPOSTPAIDCompany()"/> POSTPAID&nbsp;&nbsp;&nbsp;-->
    ...
    <tr>
    <td align="right"><label for="ddlCircleName"><b style="color:#000000;">Circle Name :</b></label></td>
    <td align="left" style="color:#000000;">
    <select id="ddlCircleName" tabindex="1" title="Select circle name." onChange="SetCircleParam()" name="ddlCircleName" class="select" style="color:#000000;font-weight:bold;">
	...
	?>
     ...
     <tr>
    <td align="right">
    <label for="ddlOperator"><b style="color:#000000">Company :</b></label></td>
    <td align="left">    
    ...
    <td align="left"><input type="text" tabindex="2" title="Enter Recharge Number."  name="txtMobileNo" maxlength="15" id="txtMobileNo" class="text" style="color:#000000;font-weight:bold;font-size:22pt;height:40px;font-stretch:extra-expanded;"  /></td>
  </tr>
  <tr>
    ...
    <td align="left"><input type="text" tabindex="3" title="Confirm Recharge Number."  name="txtCMobileNo" maxlength="40" id="txtCMobileNo" class="text" style="color:#000000;font-weight:bold;font-size:22pt;height:40px;font-stretch:extra-expanded;"  /></td>
  </tr>
  <tr>
    <td align="right"><label for="txtAmount"><b style="color:#000000">Amount :</b></label></td>
    <td align="left"><input type="text" tabindex="4" title="Enter recharge amount." onKeyPress="return isNumeric(event);" name="txtAmount" maxlength="4" id="txtAmount" class="text" style="color:#000000;font-weight:bold;font-size:22pt;height:40px;font-stretch:extra-expanded;"  />
    </tr>
    
  <tr><td></td><td><input type="submit" tabindex="5" name="btnRecharge" id="btnRecharge" value="Submit" class="button" /></td></tr>
</table>
</td>
 
    <td bgcolor="#0033FF" style="border:1px solid #29A6CB;padding:0;margin:0;margin-top:-200px;position:relative;" width="40%;">
    <div style="padding:1px;background:#FFF;height:200px;"><img height="500px;" style="max-height:400px;max-width:600px;min-width:600px;" src="<?php echo base_url()."images/addHere2.png"; ?>" /></div>
    </td>
</tr>
</table>
</form>
...
<div>
   <h2 class="h2">Transaction</h2>
    ...
    <tr class="colHeader"><th class="padding_left_10px box_border_bottom box_border_right background_gray" align="left" width="120" height="30" >Recharge ID</th>
    <th class="padding_left_10px box_border_bottom box_border_right background_gray" align="left" width="120" height="30" >Transaction ID</th>
    <th class="padding_left_10px box_border_bottom box_border_right background_gray" align="left" width="120" height="30" >Company</th>
...
<td align="left"><?php echo $resultRecharge->transaction_id; ?></td>
...
<td align="left"><?php if($resultRecharge->recharge_status == "Pending"){echo "<span class='orange'>Success</span>";} ?><?php if($resultRecharge->recharge_status == "Success"){echo "<span class='green'>".$resultRecharge->recharge_status."</span>";} ?><?php if($resultRecharge->recharge_status == "Failure"){echo "<span class='red'>".$resultRecharge->recharge_status."</span>";} ?></td>
