...
<form method="post" action="agent_edit" name="frmdistributer_form1" id="frmdistributer_form1" autocomplete="off">
<input type="hidden" name="hiduserid" id="hiduserid" value="<?php echo $user_id; ?>" />



<div class="form-group">
<label for="txtRetailerName">Retailer Name :</label>
<input type="text" class="form-control" title="Enter Retailer Name." value="<?php echo $result_user->row(0)->business_name; ?>" id="txtRetailerName" name="txtRetailerName"  maxlength="100"/>
</div>

<div class="form-group">
<label for="ddlDistname">Under Distributor Name :</label>
...
<div class="form-group">
<label for="ddlRetType">Retailer Type :</label>
