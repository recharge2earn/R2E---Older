...
<form action="<?php echo base_url()."all_retailer_report"; ?>" method="post" name="frmReport" id="frmReport">
<fieldset>
...
<select title="Select Retailer Name." name="ddlUserName" id="ddlUserName" class="select">
    ...
    <?php
		$result_retailer = $this->db->query("select * from tblusers where usertype_name='Retailer' order by business_name");		
