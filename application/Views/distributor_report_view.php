...
<title>Distributor Transaction Report</title>
...
<div id="container">
 ...
 <?php require_once("a_header.php"); ?> 
  ...
  <div class="bck">
<h2>Distributor Transaction Report</h2>
<form action="<?php echo base_url()."distributor_report"; ?>" method="post" name="frmReport" id="frmReport">
<fieldset>
