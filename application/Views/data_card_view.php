...
<head>
    ...
    <title>Data Card Recharge</title>
...
<body onLoad="setdefaultcircle()"> 
 <?php include("menu.php"); ?>
  ...
  <div class="panel panel-primary">
      <div class="panel-heading">News/Alert</div>
...
<?php
 ...
 <div class="container">
    <div class="panel panel-primary">
      <div class="panel-heading">DATA CARD RECHARGE (Prepaid)</div>
      <div class="panel-body"> 

     

      <form action="<?php echo base_url()."data_card"; ?>" method="post" name="frmRecharge" id="frmRecharge" autocomplete="on" onsubmit="return validation();"> 
    <input type="hidden" name="hidSubmitRecharge" id="hidSubmitRecharge" /> 
      <input type="hidden" name="hidRechargeURL" id="hidRechargeURL" value="<?php echo base_url()."data_card"; ?>
 ...
 <div class="form-group">
     <label for="txtMobileNo">Data Card Number :</label>
 ...
 <?php
    $str_query = "select * from tblcompany where service_id='9' and company_id != 34 and company_id != 39  order by company_name";
...
<input type="submit" id="btnRecharge" name="btnRecharge" class="btn btn-primary" value="Recharge"><span id="wait_tip" style="display:none;"> Processing...<img src="images/ajax-loader2.gif"
           id="loading_img"/></span> | <a href="search_plan" target="_balank" class="btn btn-info" role="button">Search Plan</a>
          </from>
