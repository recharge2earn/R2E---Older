<html><head>
        <meta http-equiv="Content-Type" content="text/html; charset=UTF-8">        <title> rechargeportal 2 </title>
        ...
        <link rel="stylesheet" type="text/css" href="<?php echo base_url()."aircss/stylesheet_002_return.css"?>">
...
<script type="text/javascript">
			...
			function callArzooO()
			{
				 ...
				 $.ajax({
				   	url:'<?php echo base_url(); ?>air_domestic_search/getReturnArzooFlights',
					type:'post',
					cache:'false',
...
$.ajax({
				   	url:'<?php echo base_url(); ?>air_domestic_search/getReturnSearchData',
					type:'post',
					cache:'false',
					success:function(msg){
						$('#data').html(msg);
  ...
  <div style="margin-left:50px;" id="round-container-left">
                                    <div id="round-contr-in">
                                        <div>
                                            <div>
                                                <div>
                                                    <div  class="city-ti-txt-big"><?php echo $this->session->userdata("Origin"); ?> to <?php echo $this->session->userdata("Destination"); ?><div class="date-ti-txt"></div></div>
<div id="data">
</div>
</div>
                                            </div>
