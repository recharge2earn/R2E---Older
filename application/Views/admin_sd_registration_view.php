...
<title>Admin Super Dealer Registration Form</title>
...
<div id="container">
 ...
 <?php require_once("a_header.php"); ?> 
  ...
  <div class="bck">
    <h2>Super Dealer Registration</h2>
        <?php
	...
	?>
<form method="post" action="admin_sd_registration" name="frmdistributer_form1" id="frmdistributer_form1" autocomplete="off">
<fieldset>
<legend>Personal Information</legend>
<table cellpadding="5" cellspacing="0" bordercolor="#f5f5f5" width="80%" border="0">
<tbody>
<tr>
<td align="right"><label for="txtDistname"><span style="color:#F06">*</span>SuperDealer Name :</label></td><td align="left"><input type="text" class="text" title="Enter Master Distributor Name." id="txtDistname" name="txtDistname"  maxlength="100"/>
</td>
