...
<title>Edit Retailer Registration Form</title>
...
$(document).ready(function(){
	...
	//On blur
	fname.blur(validateFname);dname.blur(validateDname);postaladdr.blur(validateAddress);landmark.blur(validateLandmark);
	...
	form.submit(function(){
		if(validateFname() & validateDname() & validateAddress() & validateLandmark() & validatePin() & validateConper() & validateMobileno() & validateEmail() & validateBank() & validateAccountno() & validateOrganisation() & validateScheme())
			{				
			return true;
			}
		else
...
function setName()
{
	...
	function SetPaymentMode()
	{
	 ...
	 function setValues()
	 {		 	 	 
    	 document.getElementById('txtDistname').value = document.getElementById('hidDistID').value;
...
<div id="container">
 ...
 <?php require_once("a_header.php"); ?> 
  ...
  <div>
    <h2>Edit Retailer Registration</h2>
        <?php 
	$user_id = $this->uri->segment(3);
	$result_retailer = $this->db->query("select * from tblusers where user_id=?",array($user_id));	
	?>

<form method="post" action="retailer_form1" name="frmretailer_form1" id="frmretailer_form1" autocomplete="off">
...
<tr>
<td align="right"><label for="txtFranName"><span style="color:#F06">*</span>Retailer Name :</label></td><td align="left"><input type="text" class="text" title="Enter Retailer Name." value="<?php echo $result_retailer->row(0)->business_name; ?>" id="txtFranName" name="txtFranName"  maxlength="100"/>
<span id="fnameInfo"></span>
</td>
<td></td><td></td>
</tr>
<tr>
<td align="right"><label for="txtDistname"><span style="color:#F06">*</span>Distributor Name :</label></td><td align="left">
<input type="hidden" name="hidDistname" id="hidDistname" value="<?php echo $result_retailer->row(0)->business_name; ?>" />
<select id="txtDistname" onChange="setName()" name="txtDistname" class="select" title="Select Distributer Name.">
...
<input type="hidden" name="hidDistID" id="hidDistID" value="<?php echo $result_retailer->row(0)->parent_id; ?>" />
<span id="dnameInfo"></span>
</td>
<td></td><td></td>
</tr>
<tr>
<td align="right"><label for="txtPostalAddr"><span style="color:#F06">*</span> Postal Address :</label></td><td align="left"><textarea title="Enter Postal Address " id="txtPostalAddr" name="txtPostalAddr" class="text"><?php echo $result_retailer->row(0)->postal_address; ?></textarea>
<span id="postaladdrInfo"></span>
</td>
<td align="right"><label for="txtLandmark"><span style="color:#F06">*</span> Landmark :</label></td>
<td align="left"><input type="text" title="Enter Lanmark" value="<?php echo $result_retailer->row(0)->landmark; ?>" id="txtLandmark" name="txtLandmark" class="text" />
<span id="landmarkInfo"></span>
</td>
</tr>
<tr>
<td align="right"><label for="txtPin"><span style="color:#F06">*</span>  Pin Code :</label></td><td align="left"><input type="text" class="text" id="txtPin" value="<?php echo $result_retailer->row(0)->pincode; ?>" onKeyPress="return isNumeric(event);" name="txtPin" maxlength="6" title="Enter Pin Code." />
<span id="pinInfo"></span>
</td>
</tr>
<tr>
<td align="right">
<label for="ddlState">State :</label></td><td align="left">
...
<input type="hidden" name="hidStateID" id="hidStateID" value="<?php echo $result_retailer->row(0)->state_id; ?>" />
...
<input type="hidden" name="hidCityID" id="hidCityID" value="<?php echo $result_retailer->row(0)->city_id; ?>" />
</td>
</tr>
<tr>
<td align="right"><label for="txtConPer"><span style="color:#F06">*</span> Contact Person :</label></td><td align="left"><input title="Enter Contact Person Name." value="<?php echo $result_retailer->row(0)->contact_person; ?>" type="text" class="text" id="txtConPer" name="txtConPer" maxlength="50"/>
<span id="conperInfo"></span>
</td>
</tr>
<tr>
<td align="right"><label for="txtMobNo"><span style="color:#F06">*</span> Mobile No :</label></td><td align="left">+91<input type="text" class="text" value="<?php echo $result_retailer->row(0)->mobile_no; ?>" onKeyPress="return isNumeric(event);" title="Enter Mobile No.<br />e.g. 9898980000" id="txtMobNo" name="txtMobNo" maxlength="10"/>
<span id="mobilenoInfo"></span>
</td>
<td align="right"><label for="txtLandNo">Landline :</label></td><td align="left"><input type="text" class="text" id="txtLandNo" name="txtLandNo" value="<?php echo $result_retailer->row(0)->landline; ?>" onKeyPress="return isNumeric(event);" title="Enter Landline No.<br />e.g 07926453647" maxlength="11" /></td>
</tr>
<tr>
<td align="right"><label for="ddlRetType">Retailer Type :</label></td><td align="left"><select class="select" id="ddlRetType" name="ddlRetType" title="Select Retailer Type.<br />Click on drop down"><option value="1">Select Retailer Type</option>
<?php
...
<input type="hidden" id="hidRetailerType" name="hidRetailerType" value="<?php echo $result_retailer->row(0)->retailer_type_id; ?>" />
</td>
<td align="right"><label for="txtEmail"><span style="color:#F06">*</span> Email :</label></td><td align="left"><input type="text" class="text" id="txtEmail" value="<?php echo $result_retailer->row(0)->emailid; ?>" title="Enter Email ID.<br />e.g some@gmail.com" name="txtEmail"  maxlength="150"/><br />
...
<input type="hidden" name="hidBankID" id="hidBankID" value="<?php echo $result_retailer->row(0)->bank_id; ?>" />
...
<input type="hidden" name="hidBankId2" id="hidBankId2" value="<?php echo $result_retailer->row(0)->bank_id_2; ?>" />
</td>
</tr>
<tr>
...
<input type="hidden" name="hidAccountType1" id="hidAccountType1" value="<?php echo $result_retailer->row(0)->account_type; ?>" />
</td>
...
<input type="hidden" name="hidAccountType2" id="hidAccountType2" value="<?php echo $result_retailer->row(0)->account_type_2; ?>" />
</td>
</tr>	 	 
<tr>
<td align="right"><label for="txtAcNo"><span style="color:#F06">*</span> Account No :</label></td><td align="left"><input type="text" class="text" id="txtAcNo" value="<?php echo $result_retailer->row(0)->account_no; ?>" title="Enter Account No<br />e.g 100000005010" name="txtAcNo" maxlength="50"/>
<span id="acnoInfo"></span>
</td>
<td align="right"><label for="txtAddAcNo2">Additional A/C No2 :</label></td><td align="left"><input type="text" class="text" id="txtAddAcNo2" value="<?php echo $result_retailer->row(0)->account_no; ?>" title="Enter Account No 2.<br />e.g 1000002323900" name="txtAddAcNo2" maxlength="30"/></td>
</tr>
<tr>
...
<input type="hidden" name="hidOrganisation" id="hidOrganisation" value="<?php echo $result_retailer->row(0)->ordganisation; ?>" />
...
<input type="hidden" name="hidLanguage" id="hidLanguage" value="<?php echo $result_retailer->row(0)->prefered_language; ?>" />
</td>
</tr>
<tr>
<td align="right"><label for="ddlSchDesc"><span style="color:#F06">*</span> Scheme :</label></td><td align="left"><select class="select" id="ddlSchDesc" onChange="ChangeAmount()" title="Select Scheme Name.<br />Click on drop down" name="ddlSchDesc"><option value="0">Select Scheme</option>
<?php
$str_query = "select * from tblscheme where scheme_type='Retailer'";
...
<input type="hidden" name="hidSchemeID" id="hidSchemeID" value="<?php echo $result_retailer->row(0)->scheme_id; ?>" />
<span id="schdescInfo"></span>
</td>
<td></td><td></td>
</tr>
<tr>
<td align="right"><label for="radPayMode">Payment Mode :</label></td><td colspan="2"><input type="radio" onClick="SetPaymentMode()" value="Cash" id="radCash" name="radPayMode"/>Cash <input type="radio" onClick="SetPaymentMode()" value="Cheque" id="radCheque" name="radPayMode" checked="checked"/>Cheque <input type="radio" onClick="SetPaymentMode()" value="DD/RTGS" id="radDD" name="radPayMode"/>DD/RTGS
<input type="hidden" name="hidPaymode" id="hidPaymode" value="<?php echo $result_retailer->row(0)->payment_mode; ?>" />
</td>

</tr>
<tr>
<td align="right"><label for="txtChqDDNo">Chq No./DD No. :</label></td><td align="left"><input type="text" class="text" id="txtChqDDNo" name="txtChqDDNo" value="<?php echo $result_retailer->row(0)->cheque_dd_no; ?>" title="Enter Cheque No or Demand Draft No." maxlength="30"/></td>
<td align="right"><label for="txtChqDDDate">Cheque/DD Date. :</label></td><td align="left"><input type="text" class="text" id="txtChqDDDate" value="<?php echo $result_retailer->row(0)->cheque_dd_date; ?>" title="Enter Cheque Date or Demand Draft No." name="txtChqDDDate" maxlength="50"/></td>
</tr>
<tr>
<td align="right"><label for="ddlDepBank">Depositing Bank :</label></td><td align="left"><select class="select" id="ddlDepBank" name="ddlDepBank" onChange="setAccount()" title="Select Deposit Bank Name.<br />Click on drop down"><option>--Select--</option>
<?php echo $admin_bank;?>
</select><span id="deposit_account_no" style="font-weight:bold;"></span>
<input type="hidden" name="hidDepBankID" id="hidDepBankID" value="<?php echo $result_retailer->row(0)->depositing_bank_id; ?>" />
</td>
</tr>
<tr>
<td align="right">Amount :</td><td align="left"><span id="spAmount"><?php echo $result_retailer->row(0)->scheme_amount; ?></span>
<input type="hidden" id="hid_scheme_amount" name="hid_scheme_amount" value="<?php echo $result_retailer->row(0)->scheme_amount; ?>" />
</td><td align="right"><label for="txtWorLimit">Working Limit :</label></td><td align="left"><input type="text" title="Enter Working Limit.<br />e.g 1500,2500" onKeyPress="return isNumeric(event);" class="text" id="txtWorLimit" name="txtWorLimit" readonly="readonly" value="<?php echo $result_retailer->row(0)->working_limit; ?>" maxlength="50"/></td>
</tr>
<tr>
