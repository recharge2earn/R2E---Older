...
<title>List of MasterDealer</title>
...
<div id="container">
 ...
 <?php require_once("general_header.php"); ?> 
  ...
  <div class="bck">
<h2>View MasterDealer</h2>  
 <form action="<?php echo base_url()."d_list_mdealer" ?>" method="post" name="frmCallAction" id="frmCallAction">
...
<input type="hidden" id="hidaction" name="hidaction" value="Set" />
	...
	?>    
    <form action="<?php echo base_url()."d_list_dealer" ?>" method="post" name="frmSearch" id="frmSearch">
     <fieldset>
...
<table style="width:100%;" cellpadding="3" cellspacing="0" border="0">
    ...
    <th scope="col" align="left">Distributor Name</th>
    ...
    <?php	$i = 0;foreach($result_retailer->result() as $result) 	{  ?>
			<tr class="<?php if($i%2 == 0){echo 'row1';}else{echo 'row2';} ?>">
             <td><?php echo '<a href="'.base_url().'d_add_balance1/process/'.$result->user_id.'" class="paging">Add Bal</a>&nbsp; | &nbsp; <a href="'.base_url().'d_add_balance1/back/'.$result->user_id.'" class="paging">Revert Bal</a>'; ?></td>
