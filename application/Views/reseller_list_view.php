...
<div class="panel panel-primary">
      <div class="panel-heading">Manage API</div>
  ...
  <form id="frmCallAction" action="<?php echo base_url()."reseller_list"?>" name="frmCallAction" method="post">
...
<table id="table_id" class="table table-striped table-bordered">
  ...
  <th>Login</th>        
   ...
   <form id="frmfilter" name="frmfilter" action="<?php echo base_url()."reseller_list"?>" method="post">
   <input type="hidden" id="hidSearchFlag" name="hidSearchFlag" />
   <input type="hidden" id="hidSearchValue" name="hidSearchValue" />
   </form>
