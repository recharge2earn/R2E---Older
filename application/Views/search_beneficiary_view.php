...
<body onLoad="setdefaultcircle()">
 ...
 <?php include("dmr_menu.php"); ?>
  ...
  <div class="container">
    ...
    if($dataa!= ''){
    echo "<div class='alert alert-danger'>".$dataa."</div>";}
    ?>  



            <form action="<?php echo base_url()."search_beneficiary"; ?>" method="post" autocomplete="off" name="frmChangePassword" id="frmChangePassword">
...
<div class="container">
    ...
    <div class="panel panel-primary">
      <div class="panel-heading">Name: <b><?php echo $data['name']; ?></b>  |   Remaining Transfer Limit Rs <b> <?php echo $data['limit']; ?></b></div>
      <div class="panel-body">
...
<td>
<?php echo $value[beneficiaryName]; ?>
</td>

<td>
<?php echo $value[beneficiaryMobileNumber]; ?>
</td>

<td>
<?php echo $value[beneficiaryAccountNumber]; ?>
</td>

<td>
<?php echo $value[ifscCode]; ?>

</td>

<td>
<?php echo $value[beneficiaryId]; ?>
