...
<div id="container">
 ...
 <?php require_once("a_header.php"); ?> 
  ...
  <div class="bck">
    <h2 class="border_bottom"><span id="myLabel">Add New Scheme</span></h2>               
    <?php
...
<table style="width:100%;" id="example" class='dataTable' cellpadding="3" cellspacing="0" border="0">
    ...
    <?php	$i = 0;foreach($result_bank->result() as $result) 	{  ?>
			<tr class="<?php if($i%2 == 0){echo 'row1';}else{echo 'row2';} ?>">
            	<td class="padding_left_10px box_border_bottom box_border_right" align="left" height="34" style="min-width:120px;width:150px;"><span id="comp_<?php echo $result->bank_id; ?>"><?php echo $result->bank_name; ?></span></td>
                 <td class="padding_left_10px box_border_bottom box_border_right" align="center" height="34" style="min-width:120px;width:150px;">
              <img src="<?php echo base_url()."images/delete.PNG"; ?>" height="20" width="20" onClick="Confirmation('<?php echo $result->bank_id; ?>')" title="Delete Row" />&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
