...
<title>Customer Add Balance</title>
...
<h2>Customer Add Balance</h2>  
	...
	?>    
    <fieldset>
    <form action="<?php echo base_url()."customer_add_balance/process" ?>" method="post" name="frmBalance" id="frmBalance">
    <input type="hidden" value="<?php echo $result_customer->row(0)->user_id; ?>" name="hidUserID" id="hidUserID" />
<table style="width:100%;" cellpadding="3" cellspacing="5" border="0">
    ...
    <tr>
    <td align="right"> Name :</td> <td align="left" id="dname"><?php echo $result_customer->row(0)->business_name; ?></td>
    </tr>
    <tr>
	<td align="right">Mobile :</td>
     <td align="left"><?php echo $result_customer->row(0)->mobile_no; ?></td>
    </tr>
    <tr>
   	<td align="right">Email ID :</td>    
     <td align="left"><?php echo $result_customer->row(0)->emailid; ?></td>
    </tr>
     <tr>
