...
<meta http-equiv="content-type" content="text/html; charset=UTF-8">
    ...
    <body style="background-image:url(images/bodybck.jpg);background-repeat:inherit;">
        ...
        <div style="margin-top: -173.5px;" class="login_box">
            ...
            <form novalidate="novalidate" action="<?php echo base_url()."login"; ?>" method="post" id="login_form">
                <div class="top_b"><img src="images/aks.gif" alt=""></div>
	...
	?>                </div>
                <div class="cnt_b">
                    <div class="formRow">
                        <div class="input-prepend">
                            <span class="add-on"><i class="icon-user"></i></span><input id="username" name="username" placeholder="Username" type="text">
                        </div>
                    </div>
                    <div class="formRow" style="margin-top:10px;">
                        <div class="input-prepend">
                            <span class="add-on"><i class="icon-lock"></i></span><input id="password" name="password" placeholder="Password" value="" type="password">
                        </div>
                    </div>
                ...
                <input type="submit" class="btn btn-inverse pull-right" value="Sign In" name="btnLogin" id="btnLogin" />
                <!--<a href="PAYGPRS.jar"><b style="color:#8080FF;font-size:12px;">Download A2Z PAY GPRS App JAR File</b></a>
                ...
                <div class="btm_b clearfix">
            <h4 style="border:#000000 1px solid;color:#000000;width:210px;padding-left:8px;background-color:#D9EDF7">Download Mobile Application</h4>

                <h6>Android App to Download <a href="<?php echo base_url()."am.apk"; ?>">click here</a></h6>
                <h6>Jar App to Download  <a href="<?php echo base_url()."am.jar"; ?>">click here</a></h6>
                <h6>Jad App to Download  <a href="<?php echo base_url()."am.jad"; ?>">click here</a></h6>
