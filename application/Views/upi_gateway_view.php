...
<head>
    ...
    <title>Add Fund Using UPI </title>
  ...
  <!--  <div class="alert alert-danger"><H1>ICICI AND UPI NOT WORKING TEMPORARY, PLEASE USE ONLY HDFC BANK FOR ANY TRASACTIONS</H1></div>-->
   <?php
    ...
    <div class="panel panel-danger">
      <div class="panel-heading"><b>ADD FUND USING UPI APP/QR CODE<br>
      
      <li>No need to send add fund request after successful payment, amount will be updated automatically</li>
       
       
          <li>After successful Payment Please do not press cancel button</li>
           <li>Unique QR code is generated every time, Please dont take screen shot for future payment</li>
   
        <li>Billing is available 24x7</li>
  </div>
      <div class="panel-body">     
      
      <form action="<?php echo base_url()."upi_gateway"; ?>" method="post" autocomplete="off" name="frmChangePassword" id="frmChangePassword">
