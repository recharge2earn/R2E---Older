<?php
class Admin_agent_registration_model extends CI_Model 
{	
	function _construct()
	{
	...
	public	function add($Distname,$Parent_id,$PostalAddr,$Pin,$State,$City,$MobNo,$LandNo,$RetType,$Email,$Scheme_id,$WorLimit,$Scheme_amt,$user_type,$pan_no,$con_per)
	{
		...
		$result = $this->db->query($str_query,array($Distname,$Parent_id,$PostalAddr,$Pin,$State,$City,$MobNo,$LandNo,$RetType,$Email,$user_type,$date,$ip,$Scheme_id,$WorLimit,$Scheme_amt,$total_amount,'1','-1',$pan_no,$con_per));			
		if($result > 0)
		{
