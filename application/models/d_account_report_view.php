...
<h2>Account Ledger Report</h2>  
 <form action="<?php echo base_url()."account_report" ?>" method="post" name="frmCallAction" id="frmCallAction">
...
<input type="hidden" id="hidaction" name="hidaction" value="Set" />
	...
	?>    
     ...
     <form action="<?php echo base_url()."account_report" ?>" method="post" name="frmSearch" id="frmSearch">
     <fieldset>
     <legend>Search Category</legend>
     <table>
<tr>
<td align="right">From Date : </td>
<td align="left"><input type="text" name="txtFrom" id="txtFrom" class="text" title="Select Date." maxlength="10" /> </td>
<td align="right">To Date : </td>
<td align="left"><input type="text" name="txtTo" id="txtTo" class="text" title="Select Date." maxlength="10" /> </td>
...
<td class="padding_left_10px box_border_bottom box_border_right" align="center" height="34" style="width:80px;width:80px;"><?php echo $result->payment_date; ?></td>
 <td class="padding_left_10px box_border_bottom box_border_right" align="center" height="34" style="min-width:40px;width:50px;"><?php echo $result->payment_id; ?></td>
  ...
  <td class="padding_left_10px box_border_bottom box_border_right" align="center" height="34" style="min-width:50px;width:60px;"><?php echo $result->usertype; ?></td>
  <td class="padding_left_10px box_border_bottom box_border_right" align="center" height="34" style="min-width:80px;width:90px;"><?php echo $result->transaction_type; ?></td>
 <td class="padding_left_10px box_border_bottom box_border_right" align="center" height="34" style="min-width:150px;width:150px;"><?php echo $result->description; ?></td>
 <td class="padding_left_10px box_border_bottom box_border_right" align="center" height="34" style="min-width:120px;width:150px;"><?php echo $result->remark; ?></td>
 <td class="padding_left_10px box_border_bottom box_border_right" align="right" height="34" style="min-width:60px;width:60px;"><?php echo $result->credit_amount; ?></td>
  <td class="padding_left_10px box_border_bottom box_border_right" align="right" height="34" style="min-width:60px;width:60px;"><?php echo $result->debit_amount; ?></td>
  <td class="padding_left_10px box_border_bottom box_border_right" align="right" height="34" style="min-width:60px;width:60px;"><?php echo $result->balance; ?></td>
 </tr>
		<?php 	
		$i++;} ?>
		</table>
