<?php
class Distributer_form2_model extends CI_Model 
{	
	function _construct()
	{
...
//		$result_cr = $this->db->query($str_cr_query,array($user_id,$master_id,$WorLimit,$PayMode,'First Payment To Distibuter','Recharge',$payment_date,$payment_time,$date,$ip));
...
//		$result_dr = $this->db->query($str_dr_query,array($this->session->userdata('id'),$master_id,$WorLimit,$PayMode,'First Payment To Distibuter','Recharge',$payment_date,$payment_time,$date,$ip));		
		if($result > 0)
		{	
			return true;
		}
