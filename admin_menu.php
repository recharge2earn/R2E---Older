...
if(trim($user) == 'Admin'){?>
 ...
 <li>
                            <a href="#" class="dropdown-toggle" data-toggle="dropdown">API PANEL<span class="caret"></span></a>
                            <ul class="dropdown-menu">
                         <li><a href=<?php echo base_url()."reseller_registration";?>>REGISTER API</a></li>
                                  <li><a href=<?php echo base_url()."reseller_list";?>>MANAGE API</a></li>
                       ...
                       <li>
                            ...
                            <ul class="dropdown-menu">
                                ...
                                <li><a href=<?php echo base_url()."commission"?>>Set Commission</a></li>
                                 <li><a href=<?php echo base_url()."scheme"?>>Create Commission Plan</a></li>
                                ...
                                <li><a href=<?php echo base_url()."state";?>>Edit State</a></li>
                                  <li><a href=<?php echo base_url()."upi_setting";?>>UPI Setting</a></li>
        ...
        <div class="off-canvas-menu" style="background-color:#00A170">
            ...
            <ul class="nav nav-pills nav-stacked">
                <li class="active"><a href="/site_admin"><i class="fa fa-fw fa-home"></i> Home</a></li>
               <li>
                 ...
                 <li>
                    <a href="#" class="dropdown-toggle" data-toggle="dropdown">
                        <i class="fa fa-fw fa-user"></i>API PANEL <span class="caret"></span>
                    </a>
                    <ul class="dropdown-menu">
                        
                        <li><a href=<?php echo base_url()."reseller_registration";?> data-toggle="modal"><i class="fa fa-fw fa-users"></i>REGISTER API</a></li> 
                          <li><a href=<?php echo base_url()."reseller_list";?> data-toggle="modal"><i class="fa fa-fw fa-users"></i>MANAGE API</a></li> 
...
<li>
                    ...
                    <ul class="dropdown-menu">
                                ...
                                <li><a href=<?php echo base_url()."/scheme"?>><i class="fa fa-fw fa-check"></i>Create Scheme</a></li>
                                <li><a href=<?php echo base_url()."/commission"?>><i class="fa fa-fw fa-check"></i>Set Commission</a></li>
                                ...
                                <li><a href=<?php echo base_url()."/upi_setting";?>><i class="fa fa-fw fa-check"></i>upi_setting</a></li>
...
<ul class="dropdown-menu">
 <li><a href=<?php echo base_url()."/change_password";?>><i class="fa fa-fw fa-lock"></i>Change Password</a></li>
    ...
    <div id="pageTitle" style="background-color:#00A170" >
        <div class="container">
            <div class="row" >
                <div class="col-md-5" >
...
$response = file_get_contents("https://business.a1topup.com/recharge/balance?username=501514&pwd=adlas1234adds&format=json", false, stream_context_create($arrContextOptions));
